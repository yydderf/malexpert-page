...
export function ForceGraph({
    ...
    .on("mouseover", function(event, d) {
        ...
        curr_node.attr("data-hovered", "true")
            .each(function() {
                const parent = d3.select(this.parentNode);
                parent.append("text")
                    .attr("class", "node-hover-label")
                    .attr("x", d.x + GRAPH.OBJ.POS.X_OFFSET)
                    .attr("y", d.y + GRAPH.OBJ.POS.Y_OFFSET)
                    .text(d.label ?? d.id)
    ...
    .on("mouseout", function(event, d) {
        ...
        d3.select(this)
            ...
            .attr("r", nodeRadius);
        d3.select(curr_node.parentNode)
            .selectAll(".node-hover-label")
            .remove();
    });
